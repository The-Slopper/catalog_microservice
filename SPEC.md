# Especificacao Tecnica — Catalog

| Field | Value |
|---|---|
| Repository | `catalog_microservice` |
...
Catalog service: products, categories and search. This document describes requirements, architecture, and acceptance criteria.
